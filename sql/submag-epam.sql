...
-- Schema submag
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `submag-epam` DEFAULT CHARACTER SET utf8 ;
USE `submag-epam` ;
...
-- Table `submag`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `submag-epam`.`role` (
...
-- Table `submag`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `submag-epam`.`user` (
    ...
    CONSTRAINT `fk_user_role1`
        FOREIGN KEY (`role_id`)
            REFERENCES `submag-epam`.`role` (`role_id`)
            ON DELETE RESTRICT
            ON UPDATE CASCADE);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `submag-epam`.`category` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `submag-epam`.`magazine` (
    ...
    CONSTRAINT `fk_magazine_category1`
        FOREIGN KEY (`category_id`)
            REFERENCES `submag-epam`.`category` (`category_id`)
            ON DELETE SET NULL
            ON UPDATE CASCADE);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `submag-epam`.`subscription` (
    ...
    INDEX `fk_subscription_magazine1_idx` (`magazine_id` ASC) VISIBLE,
    PRIMARY KEY (`sub_id`),
    CONSTRAINT `fk_subscription_user`
        FOREIGN KEY (`user_id`)
            REFERENCES `submag-epam`.`user` (`user_id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_subscription_magazine1`
        FOREIGN KEY (`magazine_id`)
            REFERENCES `submag-epam`.`magazine` (`magazine_id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE);
...
-- subscription
INSERT INTO subscription (sub_id, user_id, magazine_id, start_date, end_date) VALUES(DEFAULT, 5, 1, '2021-6-04', '2021-7-04');
INSERT INTO subscription (sub_id, user_id, magazine_id, start_date, end_date) VALUES(DEFAULT, 5, 2, '2021-6-04', '2021-7-04');
INSERT INTO subscription (sub_id, user_id, magazine_id, start_date, end_date) VALUES(DEFAULT, 5, 3, '2021-6-04', '2021-7-04');
INSERT INTO subscription (sub_id, user_id, magazine_id, start_date, end_date) VALUES(DEFAULT, 5, 4, '2021-6-04', '2021-7-04');
INSERT INTO subscription (sub_id, user_id, magazine_id, start_date, end_date) VALUES(DEFAULT, 5, 6, '2021-6-05', '2020-7-04');