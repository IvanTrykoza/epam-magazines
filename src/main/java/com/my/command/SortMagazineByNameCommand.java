...
public class SortMagazineByNameCommand implements Command {

    private final Logger logger = LogManager.getLogger(SortMagazineByNameCommand.class.getName());

    @Override
    public String execute(HttpServletRequest req, HttpServletResponse res) throws DBException {

        logger.info("SortMagazineByNameCommand#execute");
        ...
        switch ((String) req.getSession().getAttribute("prevRequest")) {
            case ("showAllMagazine"):
                magazines = magazineManager.sortMagazinesByNameAllRequest(currentPage, recordsPerPage);
            ...
            case ("findMagazineByName"):
                ...
                magazines = magazineManager.sortMagazinesByNameSearchRequest(magazineName, currentPage, recordsPerPage);
            ...
            case ("sortMagazineByCategory"):
                ...
                magazines = magazineManager.sortMagazinesByNameCategoryRequest(categoryName, currentPage, recordsPerPage);
